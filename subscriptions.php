...
<a class='altlink' href='{$INSTALLER09['baseurl']}/subscriptions.php?action=".(null !== htmlsafechars($_GET["action"]))."&amp;box=". (null!== intval($_GET["box"]))."&amp;check=yes'>select all</a>
<a class='altlink' href='{$INSTALLER09['baseurl']}/subscriptions.php?action=".(null !== htmlsafechars($_GET["action"]))."&amp;box=".(null !== intval($_GET["box"]))."&amp;uncheck=yes'>un-select all</a>
