...
<div class='input-group'>
	<span class='input-group-label'>
		<i class='fab fa-picture' aria-hidden='true'></i>
	</span>			
	<input class='input-group-field' placeholder='{$lang['upload_poster']}' type='text' name='poster' aria-describedby='posterHelpText'>
</div>
<p class='help-text' id='posterHelpText'>{$lang['upload_poster1']}&nbsp;<span style='color:red;'>Do NOT add for Movies or TV. Only add IMDB link.</span></p>
<div class='input-group'>
	<span class='input-group-label'>
