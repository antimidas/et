...
function docleanup($data)
{
    ...
    if (mysqli_num_rows($res) > 0) {
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            $What_Cache_UD = (XBT_TRACKER == true ? 'user_stats_ocelot_' : 'user_stats_');
            $What_Expire = (XBT_TRACKER == true ? $INSTALLER09['expires']['u_stats_ocelot'] : $INSTALLER09['expires']['u_stats']);
            $What_Expire_UD = (XBT_TRACKER == true ? $INSTALLER09['expires']['user_stats_ocelot'] : $INSTALLER09['expires']['user_stats']);
