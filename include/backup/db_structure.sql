-- MySQL dump 10.16  Distrib 10.1.46-MariaDB, for debian-linux-gnu (x86_64)
--
...
) ENGINE=Aria AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
...
) ENGINE=Aria AUTO_INCREMENT=88 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `achievements` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `userid` (`userid`)
) ENGINE=Aria AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `announcement_main` (
  ...
  PRIMARY KEY (`main_id`)
) ENGINE=Aria AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `announcement_process` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=Aria AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `attachments` (
  ...
  KEY `postid` (`post_id`)
) ENGINE=Aria AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bonus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bonuslog` (
  ...
  KEY `type` (`type`)
) ENGINE=Aria DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1 COMMENT='log of contributors towards freeleech etc...';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bookmarks` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bugs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_config` (
  ...
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=Aria AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cards` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `categories` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cheaters` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cleanup_log` (
  ...
  PRIMARY KEY (`clog_id`)
) ENGINE=Aria AUTO_INCREMENT=768 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `countries` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dbbackup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=2948 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `failedlogins` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=3111 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=429 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `forums_bunny` (
  ...
  `place` int(10) NOT NULL DEFAULT '-1',
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `freepoll` (
  ...
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `funds` (
  ...
  `added` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `happyhour` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`)
) ENGINE=Aria AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `infolog` (
  ...
  PRIMARY KEY (`id`),
  KEY `added` (`added`)
) ENGINE=Aria AUTO_INCREMENT=982 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`),
  KEY `added` (`added`)
) ENGINE=Aria AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=839 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `poll_voters` (
  ...
  PRIMARY KEY (`vid`),
  KEY `poll_id` (`poll_id`)
) ENGINE=Aria AUTO_INCREMENT=668 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `polls` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=Aria AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `read_posts` (
  ...
  KEY `topic_id` (`topic_id`),
  KEY `user_id` (`user_id`)
) ENGINE=Aria AUTO_INCREMENT=7172 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `referrers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shoutbox` (
  ...
  PRIMARY KEY (`id`),
  KEY `for` (`to_user`)
) ENGINE=Aria AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sitelog` (
  ...
  PRIMARY KEY (`id`),
  KEY `added` (`added`)
) ENGINE=Aria AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `thankyou` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=Aria AUTO_INCREMENT=144 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `thumbsup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=162 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`)
) ENGINE=Aria AUTO_INCREMENT=9969 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=227 DEFAULT CHARSET=utf8 COLLATE=utf8_bin PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userhits` (
  ...
  KEY `added` (`added`),
  KEY `hitid` (`hitid`)
) ENGINE=Aria AUTO_INCREMENT=10460 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=Aria AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ustatus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `userid` (`userid`)
) ENGINE=Aria AUTO_INCREMENT=77 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wiki` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=Aria AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PAGE_CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-07 15:19:34
