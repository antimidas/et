...
$INSTALLER09['cookie_domain'] = '3evils.online'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
$INSTALLER09['domain'] = '3evils.online';
//== Memcache expires
...
//== PHP or xbt announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'http://3evils.online:'.TRACKER_PORT.'/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://3evils.online:'.TRACKER_PORT.'/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'http://3evils.online';
$INSTALLER09['announce_urls'][] = 'https://3evils.online';
}
...
$INSTALLER09['site_email'] = 'antimidas2007@gmail.com';
$INSTALLER09['site_name'] = "testing shiz";
