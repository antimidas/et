<?php
 ...
 /* $Id: imdb_person.class.php 701 2014-08-07 17:14:06Z DJMcTom $ */
  ...
  * @version $Revision: 701 $ $Date: 2014-08-07 18:14:06 +0100 (Thu, 07 Aug 2014) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id, mdb_config $config = null) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 701 $');
    $this->setid($id);
  }
